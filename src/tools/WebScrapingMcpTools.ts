    ...
    return [
      {
        ...
        inputSchema: zodToJsonSchema(ScrapeDocumentationSchema) as any,
        outputSchema: zodToJsonSchema(ScrapeDocumentationResponseSchema) as any,
      ...
      },
      {
        ...
        inputSchema: zodToJsonSchema(GetScrapingStatusSchema) as any,
        outputSchema: zodToJsonSchema(GetScrapingStatusResponseSchema) as any,
        handler: this.getScrapingStatus.bind(this),
      },
      {
        name: 'cancel_scrape_job',
        description: 'Cancel an active or pending scraping job',
        inputSchema: zodToJsonSchema(CancelScrapeJobSchema) as any,
        outputSchema: zodToJsonSchema(CancelScrapeJobResponseSchema) as any,
      ...
      },
      {
        ...
        inputSchema: zodToJsonSchema(ForceUnlockJobSchema) as any,
        outputSchema: zodToJsonSchema(ForceUnlockJobResponseSchema) as any,
      ...
      },
      {
        ...
        inputSchema: zodToJsonSchema(ForceUnlockStuckJobsSchema) as any,
        outputSchema: zodToJsonSchema(ForceUnlockStuckJobsResponseSchema) as any,
      ...
      // Manual worker control tools removed - worker now starts/stops automatically with MCP server
      {
        ...
        inputSchema: zodToJsonSchema(ListDocumentationSourcesSchema) as any,
        outputSchema: zodToJsonSchema(ListDocumentationSourcesResponseSchema) as any,
      ...
      },
      {
        ...
        inputSchema: zodToJsonSchema(DeletePagesByPatternSchema) as any,
        outputSchema: zodToJsonSchema(DeletePagesByPatternResponseSchema) as any,
        handler: this.deletePagesByPattern.bind(this),
      },
      {
        name: 'delete_pages_by_ids',
        description: 'Delete specific pages by their IDs',
        inputSchema: zodToJsonSchema(DeletePagesByIdsSchema) as any,
        outputSchema: zodToJsonSchema(DeletePagesByIdsResponseSchema) as any,
      ...
      },
      {
        ...
        inputSchema: zodToJsonSchema(DeleteAllWebsitePagesSchema) as any,
        outputSchema: zodToJsonSchema(DeleteAllWebsitePagesResponseSchema) as any,
