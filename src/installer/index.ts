...
function createProjectConfig(): void {
  ...
  const requiredPermissions = [
    ...
    "mcp__zmcp-tools__close_room",
    "mcp__zmcp-tools__delete_room",
    ...
    "mcp__zmcp-tools__navigate_to_url",
    "mcp__zmcp-tools__scrape_content",

    // Web Scraping & Documentation Tools (9 tools)
    "mcp__zmcp-tools__scrape_documentation",
    "mcp__zmcp-tools__get_scraping_status",
    "mcp__zmcp-tools__cancel_scrape_job",
    "mcp__zmcp-tools__force_unlock_job",
    "mcp__zmcp-tools__force_unlock_stuck_jobs",
    "mcp__zmcp-tools__list_documentation_sources",
    "mcp__zmcp-tools__delete_pages_by_pattern",
    "mcp__zmcp-tools__delete_pages_by_ids",
    "mcp__zmcp-tools__delete_all_website_pages",
    ...
    "mcp__zmcp-tools__cleanup_orphaned_projects",

    // TreeSummary Tools (5 tools)
    "mcp__zmcp-tools__update_file_analysis",
    "mcp__zmcp-tools__remove_file_analysis",
    "mcp__zmcp-tools__update_project_metadata",
    "mcp__zmcp-tools__get_project_overview",
    "mcp__zmcp-tools__cleanup_stale_analyses",

    // Plan Tools (6 tools)
    "mcp__zmcp-tools__create_execution_plan",
    "mcp__zmcp-tools__get_execution_plan",
    "mcp__zmcp-tools__execute_with_plan",
    "mcp__zmcp-tools__list_execution_plans",
    "mcp__zmcp-tools__delete_execution_plan",
    "mcp__zmcp-tools__update_execution_plan",
